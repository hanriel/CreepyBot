...
namespace CreepyBot
{
    class test
    {
            ...
            public test(string Server, int Port, string Nick, string UserName)
            {
                this.Server = Server;
                this.Port = Port;
                this.Nick = Nick;
            ...
            /// </summary>
            public Message ReturnedMessage
            {
                get
                {
